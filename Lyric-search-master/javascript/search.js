                ...
                if(dataSearch.songName[numSearch].includes(wordSearch)){
                    if(numTotalSongSearch===0)
                        {   //create main div of songs
                            ...
                            document.querySelector(".container-songs").getElementsByTagName("H3")[0].innerHTML="Bài Hát";
                        }
                    ...
                    //create card containers with atributes
                        ...
                        newPSSong[numTotalSongSearch].innerHTML=`<a href="song.html?id=${dataSearch.songID[numSearch]}"><b>Bài hát:</b> <span>${dataSearch.songName[numSearch]}</span></a>`;
                        ...
                        newPASong[numTotalSongSearch].innerHTML=`<a href="artist.html?id=${dataSearch.artistID[numSearch]}"><b>Ca sĩ:</b> <span>${dataSearch.artistName[numSearch]}</span></a>`;
                    ...
                    if(totalArtistSearch.includes(dataSearch.artistName[numSearch])==false){
                        if(numTotalArtistSearch===0)
                        {
                            ...
                            document.querySelector(".container-artist").getElementsByTagName("H3")[0].innerHTML="Ca sĩ";
                        }
                        ...
                        newPArtist[numTotalArtistSearch].innerHTML=`<a href="artist.html?id=${dataSearch.artistID[numSearch]}"><b>Ca sĩ:</b> <span>${dataSearch.artistName[numSearch]}</span></a>`;
                    ...
                    if(numTotalSuggestionsSearch===0)
                    {
                        ...
                        document.querySelector(".container-suggestions").getElementsByTagName("H3")[0].innerHTML="Gợi ý";
                    }
                    ...
                    //create card containers with atributes
                        ...
                        newPASuggestions[numTotalSuggestionsSearch].innerHTML=`<a href="artist.html?id=${dataSearch.artistID[numSearch]}"><b>Ca sĩ:</b> <span>${dataSearch.artistName[numSearch]}</span></a>`;
                        ...
                        newPSSuggestions[numTotalSuggestionsSearch].innerHTML=`<a href="song.html?id=${dataSearch.songID[numSearch]}"><b>Bài hát:</b> <span>${dataSearch.songName[numSearch]}</span></a>`;
